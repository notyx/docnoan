...
export default function Hero() {
  return (
    <section className="relative w-full min-h-screen flex flex-col items-center justify-center pt-24 pb-16 px-4 overflow-hidden">
      {/* Background Glows */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[900px] h-[500px] bg-blue-700/20 blur-[140px] rounded-full pointer-events-none" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          <span className="inline-block py-1 px-4 mb-6 bg-blue-500/10 border border-blue-500/30 rounded-full text-sm font-medium text-blue-300 backdrop-blur-sm">
          ...
          <p className="text-blue-400 font-semibold text-base md:text-lg mb-12 max-w-2xl mx-auto">
        ...
        <motion.div
          ...
          className="relative w-full max-w-4xl mx-auto aspect-video rounded-2xl overflow-hidden border border-blue-500/20 shadow-[0_0_60px_rgba(59,130,246,0.15)] bg-black/60 backdrop-blur-md"
        >
